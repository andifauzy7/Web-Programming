		...
		<div class="container">
			...
			<form action="" class="was-validated" method="post">
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" id="nama" placeholder="Enter Player" name="nama" required>
			  </div>

			  <div class="form-group">
			    <label for="asal">Country :</label>
			    <input type="text" class="form-control" id="asal" placeholder="Enter Country" name="asal" required>
			  </div>

			  <div class="form-group">
			    <label for="nomor">Number :</label>
			    <input type="text" class="form-control" id="nomor" placeholder="Enter Number" name="nomor" required>
			  </div>

			  <div class="form-group">
			    <label for="gambar">Pictures :</label>
			    <input type="text" class="form-control" id="gambar" placeholder="Enter Pictures" name="gambar" required>
			  </div>
